...
let inicioLogin = document.getElementById("inicioLogin");
let inicioRegister = document.getElementById("inicioRegister");

inicioLogin.addEventListener("click", function() {
    /* clasList lista de clases */
    if (email !== "" && password !== "") {
        
        setTimeout(iniciarsecion, 1000)
        function iniciarsecion() {
            location.href = "inicio.html"
        }
        alert("¡Se ha iniciado seccion correctamente!");
    }
});
inicioRegister.addEventListener("click", function() {
    /* clasList lista de clases */
...
let loginCel = document.getElementById("loginCel"); /* Circulo */
